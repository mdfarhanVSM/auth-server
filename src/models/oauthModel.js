...
const model = {
  ...
  async getAuthorizationCode(code) {
    try {
      ...
      console.error(
        `[AUTH SERVER] Error in getAuthorizationCode: ${error.message}`,
      );
      return null;
    }
  },
  ...
  async saveAuthorizationCode(client, user, redirectUri, scope) {
    try {
      ...
      console.error(
        `[AUTH SERVER] Error in saveAuthorizationCode: ${error.message}`,
      );
      return null;
    }
  },
  ...
  async revokeAuthorizationCode(code) {
    try {
      ...
      console.error(
        `[AUTH SERVER] Error in revokeAuthorizationCode: ${error.message}`,
      );
      return false;
    }
  },
